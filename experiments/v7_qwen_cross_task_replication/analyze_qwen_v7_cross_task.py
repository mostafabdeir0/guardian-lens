...
EXP = ROOT / "experiments" / "v7_qwen_cross_task_replication"

RAW = EXP / "outputs" / "qwen_v7_raw.jsonl"
RAW_FREEZE = EXP / "QWEN_V7_RAW_FREEZE.json"
PREDICTIONS = (
    ROOT
    / "experiments"
...
EXPECTED_RAW_SHA256 = (
    "ce7fea1762084810ba571a26b91816e4"
    "834decd1e404478188fe4dd1239a36f4"
)
...
def main() -> int:
    ...
    valid = [
        ...
        if (
            ...
            and record.get("choice_validity")
            == "valid"
        )
    ]
    ...
    metadata = {
        "experiment": (
            "Qwen V7 cross-task "
            "predictive-validity replication"
        ),
        "raw_sha256": raw_sha,
        "predictions_sha256": (
            predictions_sha
    ...
    print(
        "PASS: Qwen V7 analysis complete."
    )
    print()
