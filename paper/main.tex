...
All three pre-specified extension hypotheses remained supported after
...
dependent on the designated visual trigger. No switching point was
observed for either active prioritization condition through the maximum
tested 80\% penalty.
